...
6. Confirm all eight golden journeys green in CI (testing-strategy.md §2 — journey 8 is UIX-6's `partialRun.spec`); tag `v1.0.0`; verify the Pages deployment serves the tagged build; close out the master checklist.
